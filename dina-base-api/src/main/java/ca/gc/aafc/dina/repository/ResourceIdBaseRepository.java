...
public class ResourceIdBaseRepository {
  ...
  public ResourceIdBaseRepository(ResourceNameIdentifierService resourceNameIdentifierService, Map<String, Class< ? extends DinaEntity>> typeToEntity) {
  ...
  public UUID findOne(String queryString) {
    ...
    return resourceNameIdentifierService.findByName(typeToEntity.get(resourceNameIdentifierDto.getType()), resourceNameIdentifierDto.getName(), resourceNameIdentifierDto.getGroup());
  }
