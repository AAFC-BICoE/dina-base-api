...
----
  public static final class StudentDto { // DTO Class
    ...
    @JsonApiRelation // normal relation marked with annotation
    private StudentDto normalRelation;

    // This is also a relation ( different data types between DTO/Entity but with a related entity )
  ...
  public static class Student { // Entity Class
    ...
    private Student normalRelation; // normal relation

    private List<Task> anotherRelation; // normal relation

    private UUID externalRelation; // External Relations
  }
----
