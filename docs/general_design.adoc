...
When mapping between an entity and a Dto, each field needs to transferred from one object to another. However, the values do not map directly. There are a few concepts to consider.
